...
function A1info(){
   ...
   Aimg2.style.opacity="0.6";
   Aimg3.style.opacity="0.6";
   Aimg4.style.opacity="0.6";
   ZAimg2.style.opacity="0.6";
   ZAimg3.style.opacity="0.6";
   ZAimg4.style.opacity="0.6";
...
function A2info(){
    ...
    Aimg1.style.opacity="0.6";
    Aimg3.style.opacity="0.6";
    Aimg4.style.opacity="0.6";
    ZAimg1.style.opacity="0.6";
    ZAimg3.style.opacity="0.6";
    ZAimg4.style.opacity="0.6";
    readnow.style.display="flex";
    notnow.style.display="flex";
 ...
 function B1info(){
   ...
   Bimg2.style.opacity="0.6";
   Bimg3.style.opacity="0.6";
   Bimg4.style.opacity="0.6";
   ZBimg2.style.opacity="0.6";
   ZBimg3.style.opacity="0.6";
   ZBimg4.style.opacity="0.6";
 ...
 function B2info(){
    ...
    Bimg1.style.opacity="0.6";
    Bimg3.style.opacity="0.6";
    Bimg4.style.opacity="0.6";
    ZBimg1.style.opacity="0.6";
    ZBimg3.style.opacity="0.6";
    ZBimg4.style.opacity="0.6";
    readnowb.style.display="flex";
    notnowb.style.display="flex";
